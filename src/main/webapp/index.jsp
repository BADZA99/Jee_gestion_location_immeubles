...
<!-- <h1 class="text-3xl text-blue-500 font-bold underline"><%= "Hello World!" %>
</h1>
<br/>
<a href="hello-servlet">Hello Servlet</a> -->
<!-- hero seciton -->
<div class="relative w-full h-[520px]" id="home">
    <div class="absolute inset-0 opacity-70">
        <img src="https://i.pinimg.com/564x/2c/bd/6f/2cbd6f773bb58295496b12377c5248c8.jpg" alt="Background Image" class="object-cover object-center w-full h-full" />

    </div>
    <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-between">
        <div class="md:w-1/2 mb-4 md:mb-0">
            <h1 class="text-grey-700 font-medium text-4xl md:text-5xl leading-tight mb-2">BN LOCATION</h1>
            <p class="font-regular text-xl mb-8 mt-4">One stop solution for REAL ESTATE services</p>
            <a href="#contactUs"
